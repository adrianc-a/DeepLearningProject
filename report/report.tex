...
\cite{one, two, three} the authors propose the reinforcement learning for the
...
can be the source of performance limitation. \cite{one} and \cite{two} deploy a pre-existing
...
\begin{figure}
	\centering
    \includegraphics[angle=90,origin=c,scale=0.2]{network}
