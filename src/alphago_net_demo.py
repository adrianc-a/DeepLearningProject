...
with sess.as_default():
        ...
        loss_out = sess.run(loss, feed_dict={inp:new_vec, valY:valy,
...
policy_out, value_out = net.forward(new_vec)

# get the value of the loss function for a batch of data
loss_val = net.forward_loss(new_vec, poly, valy)

# running 100 training steps given a batch
for i in range(100):
    net.training_step(new_vec, poly, valy)
